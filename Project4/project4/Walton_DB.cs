        ...
        while (Retry >= 0)
        {
            try
            {
                if (lo_Connection == null)
                {
                    ...
                    lo_Connection.ConnectionString = "Data Source=msenterprise.waltoncollege.uark.edu;Initial Catalog=3393_Shipp_Fall2019;user id=lrd002;password=BizDevPass10761207!;Persist Security Info=False;";
                }
