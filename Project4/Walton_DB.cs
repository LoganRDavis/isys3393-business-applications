        ...
        while (Retry >= 0)
        {
            try
            {
                if (lo_Connection == null)
                {
                    ...
                    lo_Connection.ConnectionString = "Data Source=msenterprise.waltoncollege.uark.edu;Initial Catalog=<database>;user id=<user>;password=<password>;Persist Security Info=False;";
                }
